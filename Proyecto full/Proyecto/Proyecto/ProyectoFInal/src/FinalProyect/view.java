...
public class view {
    ...
    public static void register() {
        ...
        do {
            ...
            switch (opc) {
                case 1 -> {
                    System.out.println("Tipo de documento: 1 para cedula o 2 para RUT o 3 para NIT: ");
                ...
                case 2 -> {
                    ...
                    String typeTransport = scan.next();
                ...
                case 3 -> {
                    ...
                    Suplier objsuplier = new Suplier(typeDocument, city, name, date);
    ...
    private static void search() {
        char sw;
        System.out.println("\nConsultar");
        System.out.println("¿Desea consultar a alguien? S/N :");
        char swTwo = scan.next().toUpperCase().charAt(0);
        if (swTwo == 'S'){
    ...
    private static void update() {
        ...
        System.out.println("\nActualizar");
        System.out.println("¿Desea Actualizar a alguien? S/N :");
        char swTwo = scan.next().toUpperCase().charAt(0);
    ...
    private static void remove() {
        ...
        System.out.println("¿Desea remover a alguien? S/N :");
        char swTwo = scan.next().toUpperCase().charAt(0);
    ...
    private static void list() {
        ...
        if (result != "" || resultTran != "" || resultPro != ""  ) {
            System.out.println("\nLista de clientes");
            System.out.println(result);
